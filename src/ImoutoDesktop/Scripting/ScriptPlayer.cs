...
public class ScriptPlayer : DispatcherObject
{
    ...
    private void Invoke(Action method) => Dispatcher.Invoke(DispatcherPriority.Normal, method);

    private void Invoke<T>(Action<T> method, T arg) => Dispatcher.Invoke(DispatcherPriority.Normal, method, arg);

    private void AsyncInvoke(Action method) => Dispatcher.BeginInvoke(DispatcherPriority.Normal, method);

    private void AsyncInvoke<T>(Action<T> method, T arg) => Dispatcher.BeginInvoke(DispatcherPriority.Normal, method, arg);
